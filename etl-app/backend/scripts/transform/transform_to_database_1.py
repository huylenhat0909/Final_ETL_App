...
def transform_to_database_1():
    ...
    companies = read_latest_file_in_directory('/home/anhcu/Final_ETL_App/etl-app/backend/data/raw/companies')
    ...
    regions_path = f"/home/anhcu/Final_ETL_App/etl-app/backend/data/processed/transformed_to_database_regions/process_regions_{date}.json"
    ...
    industries_path = f"/home/anhcu/Final_ETL_App/etl-app/backend/data/processed/transformed_to_database_industries/process_industries_{date}.json"

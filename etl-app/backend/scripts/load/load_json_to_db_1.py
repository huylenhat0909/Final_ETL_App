...
def load_json_to_db_1():
    ...
    insert_data_from_json(
        get_latest_file_in_directory(
            '/home/anhcu/Final_ETL_App/etl-app/backend/data/processed/transformed_to_database_regions', 
            '.json'
        ),
        'regions',
    ...
    insert_data_from_json(
        get_latest_file_in_directory(
            '/home/anhcu/Final_ETL_App/etl-app/backend/data/processed/transformed_to_database_industries', 
            '.json'
        ),
        'industries',
    ...
    insert_data_from_json(
        get_latest_file_in_directory(
            '/home/anhcu/Final_ETL_App/etl-app/backend/data/processed/transformed_to_database_sicindustries', 
            '.json'
        ),
        'sicindustries',
